        ...
        <div className="row container">
            <div className="columns" data-aos="fade-right" data-aos-delay="300">
                ...
                <ul>
                    ...
                    <li>
                        <p><span>Email:</span> hautrantrung2005@gmail.com</p>
                    </li>
                    <li>
                        <p>
                            <span>
                ...
                <div className="mas-info">
                    <a href={cv} target="_blank" rel="noopener noreferrer" download="Tran-Trung-Hau-CV.pdf" className="btn-codigo buttonDownload">
                        <FormattedMessage
                            id='btn-cv'
